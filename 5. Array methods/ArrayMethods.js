...
const avarageValue=getAverage(6, 2, 55, 11, 78, 2, 55, 77, 57, 87, 23, 2, 56, 3, 2)
console.log("Avarage for (6, 2, 55, 11, 78, 2, 55, 77, 57, 87, 23, 2, 56, 3, 2) is ",avarageValue);
...
const calculateMediana=getMedian(6, 2, 55, 11, 78, 2, 55, 77, 57, 87, 23, 2, 56, 3, 2)
console.log("Mediana of 6, 2, 55, 11, 78, 2, 55, 77, 57, 87, 23, 2, 56, 3, 2 is ",calculateMediana)
...
console.log("Filtered numbers 1, 2, 3, 4, 5, 6 without even numbers is ", filterEvenNumbers(1, 2, 3, 4, 5, 6))
...
console.log("Number of positive numbers in 1, -2, 3, -4, -5, 6 is ",positiveNumbersCount )